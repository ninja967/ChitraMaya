...
function PhaseChip({ phase }: { phase: FilmPhase }) {
  if (phase === "outline") {
    return (
    ...
    <div className="space-y-4">
      ...
      <Field label="Image prompt" hint="Sent to image generation. Trigger words, lighting, lens, mood.">
        <textarea
          ...
          placeholder="maya_prototype, workshop interior, neon underglow, cinematic anamorphic lens, moody lighting"
        />
      </Field>
