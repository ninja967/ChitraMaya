...
# Run this AFTER infra/bootstrap.sh has completed successfully

PYTHON_BIN="/root/comfyui-venv/bin/python"
TRAINING_DIR="/root/chitramaya-training"
...
DATASET_DIR="${1:-/root/chitramaya-training/datasets/sample}"
OUTPUT_NAME="${2:-my-lora}"
OUTPUT_DIR="/root/chitramaya-training/outputs/${OUTPUT_NAME}"
PYTHON_BIN="/root/comfyui-venv/bin/python"
